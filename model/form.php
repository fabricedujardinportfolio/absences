        ...
        <div class="col-6 formulaire m-auto ">
          ...
          <div class="col-md-12   text-center">
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" placeholder="Saisir le prénom de l'agent" aria-label="name" id="name" name="name" onkeyup="autocomplet()" autocomplete="off" onclick="datnow();">
              <span>
                <ul class="text-success fst-italic ps-0 overflow-auto h-50 text-start" style="cursor: pointer; display: none;" id="name_list">
              ...
              <div class="col-md-12 col-12 text-center pt-5 pt-md-0 m-auto mt-3 mt-md-0 align-self-center">
                <div class="button-absence-<?= $post['id'] ?> d-md-flex justify-content-center" id="button-absence-<?= $post['id'] ?>">
                  ...
                  <a class="btn-<?= $post['id'] ?>" href="#">
                    <button type='button' id="button-absence-<?= $post['id'] ?>" class='btn btn-sm btn-outline-secondary ' onclick="update('<?= $post['id'] ?>','<?= $post['motif_end'] ?>','<?= $post['motif_end_id'] ?>','<?= $post['motif_start'] ?>','<?= $post['motif_start_id'] ?>','<?= $post['date_start'] ?>','<?= $post['date_end'] ?>')">Modifier</button>
                  </a>
                </div>
                <button type='submit' name="button-absence" value="<?= $post['id'] ?> " id="updateur-<?= $post['id'] ?>" class="btn btn-sm btn-outline-secondary text-uppercase mt-2 " style="display:none">valider</button>
              </div>
            </div>
